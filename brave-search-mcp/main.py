...
def main():
    ...
    print("1. For LangChain demo: python -c 'from langchain_client import run_langchain_demo; run_langchain_demo(\"your query here\")'")
    print("2. For AutoGen demo: python -c 'from autogen_client import run_autogen_demo; run_autogen_demo(\"your query here\")'")
    print("3. For interactive UI in Jupyter/Colab: from demo_ui import create_demo_ui; create_demo_ui()")
